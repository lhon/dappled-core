// from site-packages/dashboards_bundlers/local_deploy/static/urth/dashboard.js
// removing Thebe dependencies
/**
...
define(['jquery'], function($) {
    ...
    function initGrid() {
        ...
        require(['urth-common/gridstack-custom'], function(Gridstack) {
            ...
            var gridstack = $container.gridstack({
                verticalMargin: Urth.cellMargin,
                cellHeight: Urth.defaultCellHeight,
    ...
    return {
        init: function() {
            ...
            return $.when(layout_ready).then(_showDashboard);
        },
